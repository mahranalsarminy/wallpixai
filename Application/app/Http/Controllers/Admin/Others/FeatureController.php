...
class FeatureController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->has('lang')) {
            ...
            return view('admin.others.features.index', ['features' => $features, 'active' => $language->name]);
        } else {
    ...
    {
        return view('admin.others.features.create');
    }
    ...
    {
        return view('admin.others.features.edit', ['feature' => $feature]);
    }
