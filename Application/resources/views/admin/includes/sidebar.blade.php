        ...
        <div class="vironeer-sidebar-links">
            <div class="vironeer-sidebar-links-cont">
                ...
                <a href="{{ route('admin.images.index') }}"
                    class="vironeer-sidebar-link {{ request()->segment(2) == 'images' ? 'current' : '' }}">
                    <p class="vironeer-sidebar-link-title">
                        <span><i class="far fa-images"></i>{{ admin_lang('Manage Images') }}</span>
                        @if ($unviewedGeneratedImages)
                            <span class="counter">{{ $unviewedGeneratedImages }}</span>
                        @endif
                    </p>
                </a>
            ...
            <div class="vironeer-sidebar-links-cont">
                ...
                <div class="vironeer-sidebar-link {{ request()->segment(2) == 'settings' ? 'active' : '' }}"
                    ...
                    <div class="vironeer-sidebar-link-menu">
                        ...
                        <a href="{{ route('admin.settings.engines.index') }}"
                            class="vironeer-sidebar-link {{ request()->segment(3) == 'engines' ? 'current' : '' }}">
                            <p class="vironeer-sidebar-link-title"><span>{{ admin_lang('Engines') }}</span>
                            </p>
                        </a>
                        <a href="{{ route('admin.settings.generation') }}"
                            class="vironeer-sidebar-link {{ request()->segment(3) == 'generation' ? 'current' : '' }}">
                            <p class="vironeer-sidebar-link-title"><span>{{ admin_lang('Image Generation') }}</span>
                            </p>
                        </a>
                        <a href="{{ route('admin.settings.smtp.index') }}"
                            class="vironeer-sidebar-link {{ request()->segment(3) == 'smtp' ? 'current' : '' }}">
                            <p class="vironeer-sidebar-link-title"><span>{{ admin_lang('SMTP Settings') }}</span>
                            </p>
                        </a>
                        <a href="{{ route('admin.settings.pages.index') }}"
                            class="vironeer-sidebar-link {{ request()->segment(3) == 'pages' ? 'current' : '' }}">
                            <p class="vironeer-sidebar-link-title"><span>{{ admin_lang('Manage Pages') }}</span></p>
                        </a>
                        <a href="{{ route('admin.settings.oauth-providers.index') }}"
                            class="vironeer-sidebar-link {{ request()->segment(3) == 'oauth-providers' ? 'current' : '' }}">
                            <p class="vironeer-sidebar-link-title"><span>{{ admin_lang('OAuth Providers') }}</span>
                            </p>
                        </a>
                        ...
                        <a href="{{ route('admin.settings.captcha-providers.index') }}"
                            ...
                            <p class="vironeer-sidebar-link-title"><span>{{ admin_lang('Captcha Providers') }}</span>
                            </p>
                        </a>
                        ...
                        <a href="{{ route('admin.settings.taxes.index') }}"
                            ...
                            <p class="vironeer-sidebar-link-title"><span>{{ admin_lang('Taxes') }}</span>
                            </p>
                        </a>
                    </div>
                </div>
