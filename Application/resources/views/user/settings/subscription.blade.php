                ...
                <div class="card-v p-0">
                    <div class="settings-box">
                        <div class="settings-box-header border-bottom px-4 py-4">
                            <h6 class="mb-0">{{ lang('My Subscription', 'account') }}</h6>
                        </div>
                            ...
                            @if ($user->isSubscribed() && !$user->subscription->isCancelled())
                                <div class="subscription-box">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        @if ((!$user->subscription->isFree() && $user->subscription->isAboutToExpire()) || $user->subscription->isExpired())
                                            <div class="col-12 col-lg-auto">
                                                <form
                            ...
                            @else
                                <div class="py-5 text-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mb-3" width="150" height="150"
                                        ...
                                        <rect x="60.40639" y="139.84921" width="280.48127" height="277.59048" rx="26.74409"
                                            fill="#f2f2f2" />
                                        <path
                                        ...
                                        <rect x="243.92262" y="316.26256" width="60" height="7" rx="3.5"
                                            fill="{{ $settings->colors->primary_color }}" />
                                        <rect x="419.92262" y="306.76256" width="44" height="26" rx="3.5"
                                            fill="{{ $settings->colors->primary_color }}" />
