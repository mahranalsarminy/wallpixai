...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/install/css/app.css') }}" />
</head>
            ...
            <div class="row justify-content-sm-between align-items-center g-3">
                ...
                <div class="col-12 col-sm-auto">
                    <div class="vironeer-footer-links">
                        <a href="https://codecanyon.net/user/vironeer"
                            class="link">{{ installer_trans('Envato') }}</a>
                        <a href="https://twitter.com/vironeer" class="link">{{ installer_trans('Twitter') }}</a>
                        <a href="https://t.me/vironeer" class="link">{{ installer_trans('Get Help') }}</a>
                    </div>
                </div>
            </div>
        </div>
